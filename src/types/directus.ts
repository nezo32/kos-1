...
export type DirectusRoles = {
  ...
  app_access: boolean;
  available_users: any[] & JunctionDirectusUsersDirectusRoles[];
  description?: string | null;
  enforce_tfa: boolean;
  icon: string;
  id: string;
...
export type DirectusUsers = {
  ...
  available_roles: any[] & JunctionDirectusUsersDirectusRoles[];
...
export type Disciplines = {
  children: any[] & Disciplines[];
  code?: string | null;
  date_created?: string | null;
  date_updated?: string | null;
  department?: (string & Departments) | null;
  disciplines_files: any[] & DisciplinesFiles[];
  id: string;
  mines_id?: string | null;
  name?: string | null;
...
export type DisciplinesFiles = {
  ...
  documents_parts: any[] & DocumentsParts[];
...
export type DocumentsParts = {
  date_created?: string | null;
  date_updated?: string | null;
  discipline_file?: (string & DisciplinesFiles) | null;
  id: string;
  key?: string | null;
  oop_file?: (string & OopFiles) | null;
  user_created?: (string & DirectusUsers) | null;
  user_updated?: (string & DirectusUsers) | null;
  value?: unknown | null;
};
...
export type CustomDirectusTypes = {
  ...
  documents_parts: DocumentsParts[];
  edu_forms: EduForms[];
